...
function addPlanets() {
    planets_names.forEach(function(a) {
        $.ajax({
            ...
            success: function(b) {
                var c = Planet(b);
                planets.push(c), targetList.push(c), scene.add(c), console.log("Added planet " + a + " on the scene")
            },
            error: function() {
                console.log("Cannot retrieve data for planet: " + a)
            }
        })
    })
}
